...
public class GenericConsumerExample {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(GenericConsumerExample.class);
    ...
    public static void main(String[] args) {
        ...
        try (KafkaConsumer<String, GenericRecord> consumer = new KafkaConsumer<>(getProperties())) {
            ...
            while(true) {
                ...
                ConsumerRecords<String, GenericRecord> records =  consumer.poll(PollingTimeoutMilliseconds);
